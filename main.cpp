...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //setting up vec3
        glm::vec3 viewPosi = camera.Position;
        glm::vec3 lightPosi = lightPos;
        glm::vec3 lightColor(0.4f, 0.5f, 1.0f);
        ...
        //setting up uniform vec3 from fragment shader
        glUniform3f(glGetUniformLocation(lightingShader.Program, "viewPosi"), viewPosi.x, viewPosi.y, viewPosi.z);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "lightPosi"), lightPosi.x, lightPosi.y, lightPosi.z);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "lightColor"), lightColor.x, lightColor.y, lightColor.z);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "cubeColor"), cubeColor.x, cubeColor.y, cubeColor.z);
        
        //setting up uniform mat4 from vertex shader
